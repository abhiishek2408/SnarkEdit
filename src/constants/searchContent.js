...
export const PAGE_CONTENT = {
  ...
  'portfolio': {
    ...
    icon: ImageIcon,
    content: [
      'Welcome to the SimpleEdit Portfolio, a curated gallery showcasing the incredible talent of our global community. From stunning digital artwork and professional photography retouching to eye-catching social media graphics, this space celebrates the diverse ways our users leverage our platform to bring their ideas to life.',
      'Every image here tells a story of creativity unleashed. By providing powerful tools like advanced layering, precise color correction, and AI-driven enhancements, SimpleEdit empowers users of all skill levels to produce agency-quality results. We frequently feature standout creations from our community, highlighting the innovative techniques and unique perspectives of our users.',
      'Are you proud of a recent project you created using SimpleEdit? We are always on the lookout for fresh, inspiring work to feature in our portfolio. Share your creations with us on social media using our official hashtags, and you might just see your masterpiece displayed here, inspiring thousands of other creators worldwide.'
    ]
  },
  'careers': {
    title: 'Careers',
    icon: Briefcase,
    content: [
      'Join the team that is revolutionizing the digital design landscape. At SimpleEdit, we are always looking for passionate, forward-thinking individuals who want to make a real impact in the world of creative technology. We foster a culture of innovation, collaboration, and continuous learning, where every team member is encouraged to push boundaries and explore new ideas.',
  ...
  'cookie-policy': {
    ...
    icon: Cookie,
    content: [
      'This Cookie Policy explains how SimpleEdit uses cookies and similar tracking technologies to enhance your browsing experience. Cookies are small data files stored on your device that help us remember your preferences, understand how you interact with our platform, and deliver more relevant content. By using our website, you consent to our use of cookies in accordance with this policy.',
