...
const PAGE_CONTENT = {
  'ai-models': { title: 'AI Models', content: ['Coming Soon... Our powerful artificial intelligence models are currently in development.'] },
  'magic-eraser': { title: 'Magic Eraser', content: ['Coming Soon... Instantly remove backgrounds and unwanted objects from your photos with AI.'] },
  'about': { 
    title: 'About Us', 
    content: [
      'Welcome to SnarkEdit, your premier destination for professional, AI-powered image editing. Founded with the vision of democratizing advanced design tools, we have built a platform that bridges the gap between complex software and intuitive user experience. Our dedicated team of engineers, designers, and AI researchers work tirelessly to bring state-of-the-art capabilities directly to your browser.',
      'Our journey began when we realized that traditional image editing software was either too intimidating for beginners or too limited for professionals. SnarkEdit was conceived as the perfect middle ground—a robust, feature-rich studio that learns and adapts to your creative workflow. Whether you are retouching portraits, designing marketing materials, or creating complex collages, our platform is designed to make your creative process as seamless and enjoyable as possible.',
  ...
  'portfolio': { 
    title: 'Portfolio', 
    content: [
      'Welcome to the SnarkEdit Portfolio, a curated gallery showcasing the incredible talent of our global community. From stunning digital artwork and professional photography retouching to eye-catching social media graphics, this space celebrates the diverse ways our users leverage our platform to bring their ideas to life.',
      'Every image here tells a story of creativity unleashed. By providing powerful tools like advanced layering, precise color correction, and AI-driven enhancements, SnarkEdit empowers users of all skill levels to produce agency-quality results. We frequently feature standout creations from our community, highlighting the innovative techniques and unique perspectives of our users.',
      'Are you proud of a recent project you created using SnarkEdit? We are always on the lookout for fresh, inspiring work to feature in our portfolio. Share your creations with us on social media using our official hashtags, and you might just see your masterpiece displayed here, inspiring thousands of other creators worldwide.'
    ] 
  },
  'careers': { 
    title: 'Careers', 
    content: [
      'Join the team that is revolutionizing the digital design landscape. At SnarkEdit, we are always looking for passionate, forward-thinking individuals who want to make a real impact in the world of creative technology. We foster a culture of innovation, collaboration, and continuous learning, where every team member is encouraged to push boundaries and explore new ideas.',
